...
const staticHomePage: HomePageData = {
  ...
  whyReasons: [
    { title: "Senior delivery experience", body: "Years leading technology programmes and delivery teams inside complex organisations." },
    { title: "Hands-on development capability", body: "Current frameworks and tooling, used to actually build the work — not just scope it." },
    { title: "One point of accountability", body: "No handoffs between sales and delivery. The person who scopes the work delivers it." },
    ...
    { title: "Flexible engagement", body: "One-off projects, ongoing support, or delivery consultancy alongside your team." },
  ],
  processEyebrow: "Working together",
  processHeading: "A straightforward process, start to finish",
  processSteps: [
    { title: "Understand", body: "We start with your business, the problem, and the outcome you actually need." },
