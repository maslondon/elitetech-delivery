...
async function run() {
  ...
  await client.createOrReplace({
    ...
    whyReasons: [
      { _key: "why-1", title: "Senior delivery experience", body: "Years spent leading technology programmes and delivery teams inside complex organisations — not a portfolio built on small freelance jobs alone." },
      { _key: "why-2", title: "Hands-on development capability", body: "Current frameworks and tooling, used to actually build the work — not just scope it and hand it to a subcontractor." },
      { _key: "why-3", title: "One point of accountability", body: "No handoffs between sales and delivery. The person who scopes the work is the person who delivers it." },
      ...
      { _key: "why-6", title: "Flexible engagement", body: "One-off projects, ongoing support, or delivery consultancy alongside your existing team." },
    ],
